...
Soumika has a string S and its starting index is 1. The string S consists of characters from (1-9) . As she is very intelligent, she wants to test his brother Vinay Tendulkar. 
She asked her brother Vinay Tendulkar to count the number of even numbered characters ( i.e  2,4,6,8) for every index i (1 <= i <= |S|). 
